...
<div class="row">
		...
		<div class="card overflow-hidden ">
				<div class="card-body">
						<div class="d-flex">
						   ...
						   <h2 class="mb-1 font-anton">{{ $grupo[0]->TITULO }}</h2>
				</div>
	...
	<div class="col-xl-12 col-lg-12 col-md-12 ">
			<div class="card" >
				...
				<h2 class="card-title   ">{{ 'LISTA DE ETIQUETAS '}}</h2>
			...
			<div class="card-body" style="padding-top: 0px;">
				...
				<tbody class="table_content">
							...
							<tr>
								<th scope="row">
									{{ $item->etiqueta == null ? "No definido" : $item->etiqueta  }}  
								</th>
								<th scope="row">
									{{ $item->date_update == null ? "No definido" : $item->date_update  }}  
								</th>
								<th scope="row">
									{{ $item->count_contactos == null ? "0" : $item->count_contactos  }} 
								</th>
								<th scope="row">
									<form method="POST" action="{{ route('report_2') }}" >
									@csrf
									<input type="hidden" name="id_grupo" value="{{ $grupo[0]->ID_GRUPO }}"/>
									<input type="hidden" name="etiqueta" value="{{ $item->etiqueta }}"/>
									<button type="submit" class="btn btn-secondary btn-block bg-gradient-secondary btn-pill" > DETALLES DE ENVIO</button>
									</form>
								</th>
