...
<div class="page-header" >
    ...
    <div class="row">
									...
									<div class="card-body">
										<div class="d-flex">
											<div class="">
												...
												<h2 class="mb-1 ">{{ $grupo[0]->TITULO }}</h2>
											</div>
										</div>
									</div>
								</div>
              ...
              <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 ">
							...
							<div class="col-sm-12 col-md-12 col-lg-6 col-xl-4 ">
								<div class="card overflow-hidden ">
									<div class="card-body">
										<div class="d-flex">
											<div class="">
												<p class="mb-2 h6">TOTAL DESTINATARIOS</p>
												<h2 class="mb-1 ">{{ $total_enviado }}</h2>
											</div>
											<div class=" my-auto ml-auto">
												<!--<div class="chart-wrapper text-center">-->
												<!--	<canvas id="areaChart1" class="areaChart2 chartjs-render-monitor chart-dropshadow-primary overflow-hidden mx-auto"></canvas>-->
							...
							<div class="col-sm-12 col-md-12 col-lg-6 col-xl-4 txt-color-white">
								<div class="card overflow-hidden bg-gradient-success">
									<div class="card-body">
										<div class="d-flex">
											<div class="">
												<p class="mb-2 h6">TOTAL MENSAJES ENVIADOS</p>
												<h2 class="mb-1 " id="total_msm_sent" >{{ $count_msm }}</h2>
											</div>
											<div class=" my-auto ml-auto">
									...
									<div class="card-body">
										<div class="d-flex">
											<div class="">
												...
												<h2 class="mb-1 " id="total_time_sent" >{{ count($sent_error) }}</h2>
											</div>
											<div class="my-auto ml-auto">
												<!--<div class="chart-wrapper">-->
...
<!--	<h3 class="mb-0 mt-2"><i class="fa fa-address-book"> </i>  </h3>-->
<!--	<ul class="nav item2-gl-menu ml-auto">-->
<!--		<li><h4 class="mb-0 mt-2">{{ 'TOTAL ETIQUETAS : '. count($sent) }}</h4></li>-->
...
<div class="row">
	<div class="col-xl-12">
		<div class="card card-collapsed">
			<div class="card-header  " style="background: transparent;border:0px;" >
							<h2 class="card-title   ">{{ 'MENSAJE ENVIADO'}}</h2>
							<div class="card-options">
								<a href="{{ route('ExportSentStatusExport', ['id_grupo' => $grupo[0]->ID_GRUPO , 'etiqueta' => $etiqueta  ]) }}" >DESCARGAR</a>
		        ...
		        <div class="chat">
		          <div class="chat-container" style="margin-top: 40px;">
		            <div class="user-bar">
		              ...
		              <div class="avatar">
		                <img src="{{ asset('images_theme/logo_x1.png') }}" alt="Avatar">
		              </div>
		              <div class="name">
		                <span>{{ $grupo[0]->TITULO }} </span>
		                <span class="status">Contactos: {{ $total_enviado }}</span>
		              </div>
		            ...
		            <div class="conversation">
		              <div class="conversation-container" id="content_conversation" >
		              		@isset($msm)
			            	@forelse($msm as $item )
			            	   <div  class="message_device sent" >{{ $item->BODY }}</div>
			            	@empty
									<tr>
	...
	<div class="col-xl-12 col-lg-12 col-md-12 ">
		...
		<div class="row">
			<div class="col-xl-12 col-lg-12 col-md-12 " >
				<div class="card" >
						<div class="card-header  " style="background: transparent;border:0px;" >
							<h2 class="card-title   ">{{ 'STATUS DE MENSAJES ENVIADOS'}}</h2>
							<div class="card-options">
								<a href="{{ route('ExportSentStatusExport', ['id_grupo' => $grupo[0]->ID_GRUPO , 'etiqueta' => $etiqueta  ]) }}" >DESCARGAR</a>
								<a href="#" class="card-options-collapse" data-toggle="card-collapse"><i class="fe fe-chevron-up   "></i></a>
								<a href="#" class="card-options-fullscreen" data-toggle="card-fullscreen"><i class="fe fe-maximize   "></i></a>
					   ...
					   <div class="card-body" style="padding-top: 0px;">
					   	<div id="GetSentStatus">
								@include('report.GetSentStatus')
							</div>
							<div id="loader_GetSentStatus">
								 <h2 class="card-title   ">
							       <i class="fa fa-circle-o-notch fa-spin ml-2"></i> CARGANDO 
						       </h2>
							</div>
						</div>
				</div>
			...
			<div class="col-xl-12 col-lg-12 col-md-12 ">
				...
				<h2 class="card-title  txt-color-white ">{{ 'ERRORES DETECTADOS MENSAJES ENVIADOS'}}</h2>
				<div class="card-options">
				...
				<div class="">
					<div class="item2-gl table_r">
						<div class="table-responsive txt-color-white">
						 	<table class="table card-table  table-vcenter text-nowrap txt-color-white" style="background: transparent;border:0px;color:white;">
								<thead >
									<tr>
										  <!--<th style="color:white;">ID CONTACTO</th>-->
											<th style="color:white;">NOMBRE</th>
											<th style="color:white;">NÚMERO</th>
											<th style="color:white;">TIPO MENSAJE</th>
											<th style="color:white;">FECHA</th>
											<th style="color:white;">WHATSAPP ERROR</th>
									</tr>
								</thead>
								<tbody class="table_content txt-color-white" >
									 @isset($sent_error)
									 @forelse($sent_error  as $item)
									 <tr>
										  <!-- <th scope="row" style="color:white;">-->
												<!--		{{ $item->ID_CONTACTO  == null ? "No definido" : $item->ID_CONTACTO }}  -->
												<!--</th>-->
										   <th scope="row">
													<div class="circulo circulo_contact bg-gradient-secondary">
													  <a class="circulo_contact " style="color:white;" >{{ substr($item->NOMBRE, 0, 1) }}</a>
													</div>
													<div style="padding-top: 10px;padding-left: 50px;color:white;">
												...
												<th scope="row" style="color:white;">
														{{ $item->TYPE_MSM  == null ? "No definido" : $item->TYPE_MSM }}  
												</th>
												<th scope="row" style="color:white;">
														{{ $item->created_at  == null ? "No definido" : $item->created_at }}  
												</th>
												<th scope="row" style="color:white;">
														{{ $item->ERROR  == null ? "No definido" : $item->ERROR }}  
												</th>
									</tr>
									@empty
									<tr>
...
<!--					<img class="mr-3 avatar avatar-lg brround default-shadow" src="{{ asset('images_theme/users/2.jpg')}}" alt="image">-->
...
<!--					<img class="mr-3 avatar avatar-lg brround default-shadow" src="{{ asset('images_theme/users/11.jpg')}}" alt="image">-->
<!--					<div class="media-body">-->
...
<!--				</div>-->
<!--				<div class="media mb-5">-->
<!--					<img class="mr-3 avatar avatar-lg brround default-shadow" src="{{ asset('images_theme/users/5.jpg')}}" alt="image">-->
<!--					<div class="media-body">-->
...
<!--				</div>-->
<!--				<div class="media mb-5">-->
<!--					<img class="mr-3 avatar avatar-lg brround default-shadow" src="{{ asset('images_theme/users/12.jpg')}}" alt="image">-->
<!--					<div class="media-body">-->
...
<!--				</div>-->
<!--				<div class="media">-->
<!--					<img class="mr-3 avatar avatar-lg brround default-shadow" src="{{ asset('images_theme/users/6.jpg')}}" alt="image">-->
<!--					<div class="media-body">-->
...
<!--			<div class="">-->
<!--				<div class="text-center">-->
<!--					<img src="{{asset('images_theme/media/project-1.jpg')}}" alt="img" class="h-200 w-100">-->
<!--				</div>-->
<!--				<div class="mt-3">-->
...
<script>
 ...
 <script>
    ...
    $(document).ready(function() {
        ...
        $('#loader_GetSentStatus').hide();
    });
    function getPosts(page) {
    	  var fd = new FormData();                                                            
        fd.append('_token', "{{ csrf_token() }}" );
        fd.append('id_grupo', "{{ $grupo[0]->ID_GRUPO }}" );
        ...
        fd.append('page', page );
    	  ...
    	  $.ajax({  
               ...
               cache: false,
               data: fd,
               url: "{{ route('ajax_GetSentStatus')}}",
               beforeSend : function () { 
                  $('#loader_GetSentStatus').show();
                  $('#GetSentStatus').hide();
               },
               success: function (response) {
                  $('#GetSentStatus').html(response);
                  $('#GetSentStatus').show();
                  $('#loader_GetSentStatus').hide();
               }
        }).fail(function () {
